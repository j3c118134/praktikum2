...
<head>
    ...
    <title>Database Tabel Mahasiswa</title>
</head>
<body style="margin: 50px;">
    <h2 style="text-align: center;">Daftar Mahasiswa</h2>
    <hr style="size: 50%;"/>
    <a href="tampil_data.php" ><button type="button" class="btn btn-danger">Tampil</button></a>
    <a href="insert.php" ><button type="button" class="btn btn-danger">Tambah</button></a>
    <br>
    <br>
